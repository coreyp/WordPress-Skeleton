...
<body <?php body_class(); ?>>
	...
	<?php // removed reporters registry archive page from breadcrumbs
		if ( function_exists( 'breadcrumb_trail' ) && !is_front_page() && !is_post_type_archive('request') && !is_page('registry-request') )
